(function($) {
    ...
    function _8a(_8b) {
        ...
        if (_8c.iconCls) {
            ...
            if (_8c.iconCls == "pagination-prev") {
                $('<span class="l-btn-icon page-btn">上一页</span>').addClass(_8c.iconCls).appendTo(_8d);
                _8d.addClass("l-btn-icon-" + _8c.iconAlign)
            }
            if (_8c.iconCls == "pagination-next") {
                $('<span class="l-btn-icon page-btn">下一页</span>').addClass(_8c.iconCls).appendTo(_8d);
                _8d.addClass("l-btn-icon-" + _8c.iconAlign)
            }
    ...
    $.fn.pagination.defaults = {
        ...
        displayMsg: "显示第 {from}到第{to}数据，一共{total}条",
        nav: {
            first: {
            ...
            next: {
                ...
                handler: function() {
                    ...
                    if (_cd.pageNumber < _ce || (_cd.data && _cd.data.length>= _cd.pageSize)) {
