(function($) {
    ...
    function _8a(_8b) {
        ...
        if (_8c.text) {
            $('<span class="l-btn-text l-btn-text-border" ></span>').html(_8c.text).appendTo(_8d)
        }
        if (t.hasClass("pagination-link")) {
            t.find(".l-btn-text").each(function(index, elem) {
                var elem = $(elem);
                elem.css("color", "#2a6496")
            })
        }
        if (_8c.iconCls) {
            if (_8c.iconCls == "pagination-first") {
                $('<span class="l-btn-icon page-btn">首页</span>').addClass(_8c.iconCls).appendTo(_8d);
                _8d.addClass("l-btn-icon-" + _8c.iconAlign)
            }
            if (_8c.iconCls == "pagination-prev") {
                $('<span class="l-btn-icon page-btn"></span>').addClass(_8c.iconCls).appendTo(_8d);
                _8d.addClass("l-btn-icon-" + _8c.iconAlign)
            }
            if (_8c.iconCls == "pagination-next") {
                $('<span class="l-btn-icon page-btn"></span>').addClass(_8c.iconCls).appendTo(_8d);
                _8d.addClass("l-btn-icon-" + _8c.iconAlign)
            }
            if (_8c.iconCls == "pagination-last") {
                $('<span class="l-btn-icon page-btn">尾页</span>').addClass(_8c.iconCls).appendTo(_8d);
                _8d.addClass("l-btn-icon-" + _8c.iconAlign)
            }
            if (_8c.iconCls == "pagination-load") {
                $('<span class="l-btn-icon border-right page-btn">刷新</span>').addClass(_8c.iconCls).appendTo(_8d);
                _8d.addClass("l-btn-icon-" + _8c.iconAlign)
            }
        }
        ...
        for (var _a4 = 0; _a4 < aa.length; _a4++) {
            ...
            if (_a5 == "list") {
                ...
                for (var i = 0; i < _a1.pageList.length; i++) {
                    $("<option></option>").val(_a1.pageList[i]).text(_a1.pageList[i] + '条/页').appendTo(ps)
                }
                        ...
                        if (_a5 == "prev") {
                            ...
                            if (_a5 == "next") {
                                ...
                                if (_a5 == "last") {
                                    ...
                                    if (_a5 == "manual") {
                                        $('<span style="padding-left:6px;padding-right:10px;"></span>').html(_a1.beforePageText).appendTo(tr).wrap("<td></td>");
    ...
    function _af(_b0, _b1) {
        ...
        if (_b3.total && _b3.pageNumber > _b4) {
            _b3.pageNumber = _b4
        }
        if (!_b3.total) {
           // _b3.pageNumber = 0;
        ...
        if (bb.next) {
            bb.next.linkbutton({
                //disabled: (_b3.pageNumber == _b4) 兼容后端不返回total的场景
                disabled: _b3.total ? (_b3.pageNumber == _b4) : (_b3.data && _b3.data.length < _b3.pageSize)
            })
        }
        if (bb.last) {
            bb.last.linkbutton({
    ...
    $.fn.pagination.defaults = {
        ...
        showRefresh: true,
        links: 5,
        // layout: ["list", "first", "prev", "links", "next", "last", "refresh","manual"],
        ...
        nav: {
            ...
            next: {
                ...
                handler: function() {
                    ...
                    if (_cd.pageNumber < _ce || (!_cd.total && _cd.data && _cd.data.length>= _cd.pageSize)) {
    ...
    function _4ab(_4ac, _4ad) {
        ...
        function _4b1(_4b2) {
            ...
            referer = getReferer();
            if ($("#jackToken").length == 0) {
                form.append('<input type="hidden" name="jackToken" id="jackToken"/>')
            }
            $("#jackToken").val(getCookie("jackToken"));
            var _4b3 = $();
            try {
                for (var n in _4b2) {
        ...
        var _4b6 = 10;
        function cb(_responseData) {
            setTimeout(function() {
                    disLoad()
                },
                500);
            if (typeof str == 'string') {
                opts.success(_responseData);
            }else{
                opts.success(JSON.stringify(_responseData));
            }
    ...
    function _576(_577) {
        ...
        _57b.children("div.datagrid-header,div.datagrid-body,div.datagrid-footer").width(_57b.width()-40);
        ...
        _57b.add(_57c).children("div.datagrid-body").css({
            marginTop: _582,
            height: (isNaN(parseInt(opts.height - 50)) ? "": (_57a - _583 - 50)),
            minHeight: (_585 ? _585 - _584 - _583: ""),
            maxHeight: (_586 ? _586 - _584 - _583: "")
        });
        view.height(_57c.height() - 10)
    }
    ...
    function _5b9(_5ba) {
        ...
        dc.body1.parent().bind("scroll",
            function() {
                var b2 = dc.view2.children("div.datagrid-body");
                b2.scrollTop($(this).scrollTop());
                var c2 = dc.body2.children(":first");
                var c1 = dc.body1.children(":first");
                if (c2.length && c1.length) {
                    ...
                    var top1 = c1.offset().top;
                    if (top2 != top1) {
                        b2.scrollTop(b2.scrollTop() + top2 - top1)
                    }
                }
                dc.view2.children("div.datagrid-header,div.datagrid-footer")._scrollLeft($(this)._scrollLeft());
                dc.body2.children("table.datagrid-btable-frozen").css("left", -$(this)._scrollLeft())
    ...
    var _711 = {
        ...
        renderRow: function(_721, _722, _723, _724, _725) {
            ...
            for (var i = 0; i < _722.length; i++) {
                ...
                if (col) {
                    var _728 = eval("_725['" + _727.replace(/\./g, "']['") + "']");
    ...
    function _892(_893) {
        ...
        if (opts.multiple) {
            _894.combo.addClass('big_combo');
            _894.combo.removeClass("combo");
            _894.combo.find('.textbox-text').addClass("big_textbox_text")
        }
    }
    function _897(_898) {
    ...
    function _8b6(_8b7, text) {
        ...
        if (_8b9 != text) {
            if (_8b8.options.showAll == true && _8b8.previousText == "") {
    ...
    function _8f3(_8f4, data, _8f5) {
        ...
        if (opts.showAll == true) {
            var allRow = {};
            allRow[opts.textField] = "全部";
            allRow[opts.valueField] = "";
            allRow.selected = false;
            allRow.disabled = false;
            var newData = [allRow];
            $.each(_8f6.data,
                function(index, item) {
