package com.fhs.file.ueditor;

import com.fhs.file.ueditor.define.ActionMap;
...
public final class ConfigManager {
    ...
    public Map<String, Object> getConfig(int type) throws JSONException {
        ...
        switch (type) {
            ...
            case ActionMap.UPLOAD_IMAGE:
                ...
                conf.put("pathFormat", this.jsonConfig.getString("imagePathFormat"));
    ...
    private void initEnv() throws FileNotFoundException, IOException {
        ...
        String configContent = this.readFileJson(this.getConfigPath());
    ...
    private String getConfigPath() {
        return this.rootPath
                + File.separator + "static/js/ueditor/jsp"
    ...
    private String readFileJson(String path) throws IOException {
        ...
        try {
            ...
            InputStreamReader reader = new InputStreamReader(this.getClass().getResourceAsStream(file), "UTF-8");
