var modelConfig = {
    title: '我的成绩', pkey: 'id', type: 'uuid', orderBy: 'update_time Desc',extendsParam:'student_id=${session.user.userId}&status=已通过',
    namespace: "my_score", table: 't_school_curriculum_student_score',trans: true};
var listPage = {
