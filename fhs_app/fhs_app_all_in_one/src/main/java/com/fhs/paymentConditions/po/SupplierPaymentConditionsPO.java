package com.fhs.paymentConditions.po;
...
public class SupplierPaymentConditionsPO extends BasePO<SupplierPaymentConditionsPO> {
    ...
    private static final long serialVersionUID = -34624587778164902L;
    ...
    @Trans(type = TransType.DICTIONARY, key = "dateBase")
    ...
    @Trans(type = TransType.DICTIONARY, key = "dateBaseOmit")
