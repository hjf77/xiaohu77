...
public class UcenterFrontUser extends BaseDO<UcenterFrontUser> {
    ...
    public UcenterFrontUser(String userId, String userName, String nickName, String birthday, String mobile, String sex, String passwd, String userCard, String userResource, String language, String provinceId, String cityId, String areaId, String address, String imagePath, String isDisable, String realName) {
        this.userId = userId;
