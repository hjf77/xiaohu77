...
<script type="text/javascript">
	...
	function addRole() {
		openDialog(
				'${basePath}page/ms/ucenter/sys_role_add_update.jsp?isEdit=false&organizationId=${param.organizationId}',
				'添加角色');
	}
	...
	function updateRole(pkField) {
		openDialog(
				'${basePath}page/ms/ucenter/sys_role_add_update.jsp?isEdit=true&parentId=${param.parentId}&roleId=' + pkField, '修改角色');
	}
