...
public class StringUtils {
    ...
    public static String rightTrim(String str) {
        ...
        int index = StringUtils.length(str);
    ...
    /**
     * 将,分割的字符串格式化为 sql 可以in的
     *
     * @param str 需要格式化的字符串
     * @return 可以in的字符串
     */
    public static String getStrToIn(String str) {
        if (!str.contains(",")) {
            return "'" + str + "'";
        }
        String[] strs = str.split(",");
        return getStrToIn(strs);
    }
     ...
     * @return 可以in的字符串
     */
    public static String getStrToIn(List<String> list) {
        if (list.size() == 0) {
            return "'-1'";
        }
        if (list.size() == 1) {
        ...
        return getStrToIn(list.toArray());
    }
     ...
     * @return 可以in的字符串
     */
    public static String getStrToIn(Set<String> set) {
        if (set.size() == 0) {
            return "'-1'";
        }
        return getStrToIn(set.toArray());
    }
     ...
     * @return 可以in的字符串
     */
    public static String getStrToIn(Object[] strs) {
        return getStrForIn(ListUtils.array2List(strs), true);
    }
    ...
    public static String getStrForIntegerIn(List<? extends Object> list, String fileName) {
        ...
        for (Object obj : list) {
            strList.add(StringUtils.toString(ReflectUtils.getValue(obj, fileName)));
        }
    ...
    public static String toStringHex(String s) {
        return StringUtils.toString(Integer.parseInt(s, 16));
    }
}
