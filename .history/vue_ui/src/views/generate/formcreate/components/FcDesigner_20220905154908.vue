...
import form from '../../../../utils/generator/config/base/form';
import field from '../../../../utils/generator/config/base/field';
import validate from '../../../../utils/generator/config/base/validate';
import {deepCopy} from '@form-create/utils/lib/deepextend';
import is, {hasProperty} from '@form-create/utils/lib/type';
import {lower} from '@form-create/utils/lib/tocase';
import ruleList from '../../../../utils/generator/config/rule/index';
import draggable from 'vuedraggable';
import createMenu from '../../../../utils/generator/config/menu';
import {upper} from '../../../../utils/generator/utils/index';
import {designerForm} from '../../../../utils/generator/utils/form';
import viewForm from '@/utils/generator/utils/form';

console.log("===============>designerForm")
debugger
console.log(designerForm)
console.log(viewForm.$form())
