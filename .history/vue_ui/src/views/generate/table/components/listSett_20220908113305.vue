...
<template>
  <div>
    ...
    <div v-else>
      <el-button @click="goback()" style="float: left; margin-top: 5px; margin-left: 20px;">上一步</el-button>
      <pagex-form
        :isEdit="true"
        :isVee="false"
        :controls.sync="form"
      ...
      <formCreate :tableSchema="tableSchema" :tableName="tableName" style="margin-top: -30px"></formCreate>
    </div>
  </div>
</template>
<script>
