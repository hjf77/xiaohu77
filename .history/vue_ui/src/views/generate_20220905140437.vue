...
// import formcreate from './generate/formcreate/index'
import formcreate from './generate/formcreate/index.vue'
...
::v-deep .form-header, .table-header {
  width: 50%;
  box-sizing: border-box;
  text-align: right;
  padding: 0 20px;
