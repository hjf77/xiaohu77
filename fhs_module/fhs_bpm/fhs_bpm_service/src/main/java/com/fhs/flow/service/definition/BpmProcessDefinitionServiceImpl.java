...
import com.fhs.flow.convert.definition.BpmProcessDefinitionConvert;
...
import com.fhs.flow.dal.mysql.definition.BpmProcessDefinitionExtMapper;
...
import static com.fhs.flow.comon.utils.CollectionUtils.*;
import static com.fhs.flow.enums.ErrorCodeConstants.PROCESS_DEFINITION_KEY_NOT_MATCH;
import static com.fhs.flow.enums.ErrorCodeConstants.PROCESS_DEFINITION_NAME_NOT_MATCH;
...
public class BpmProcessDefinitionServiceImpl implements BpmProcessDefinitionService {
    ...
    public String createProcessDefinition(@Valid BpmProcessDefinitionCreateReqDTO createReqDTO) {
        ...
        // 插入拓展表
        BpmProcessDefinitionExtPO definitionDO = BpmProcessDefinitionConvert.INSTANCE.convert2(createReqDTO);
    ...
    public boolean isProcessDefinitionEquals(@Valid BpmProcessDefinitionCreateReqDTO createReqDTO) {
        ...
        BpmProcessDefinitionExtPO oldProcessDefinitionExt = getProcessDefinitionExt(oldProcessDefinition.getId());
    ...
    @Override
    public BpmProcessDefinitionExtPO getProcessDefinitionExt(String id) {
    ...
    public List<BpmProcessDefinitionRespVO> getProcessDefinitionList(BpmProcessDefinitionListReqVO listReqVO) {
        ...
        List<BpmProcessDefinitionExtPO> processDefinitionDOs = processDefinitionMapper.selectListByProcessDefinitionIds(
                convertList(processDefinitions, ProcessDefinition::getId));
        Map<String, BpmProcessDefinitionExtPO> processDefinitionDOMap = convertMap(processDefinitionDOs,
                BpmProcessDefinitionExtPO::getProcessDefinitionId);
        // 执行查询，并返回
    ...
    public PageResult<BpmProcessDefinitionPageItemRespVO> getProcessDefinitionPage(BpmProcessDefinitionPageReqVO pageVO) {
        ...
        // 获得 Form Map
        Set<Long> formIds = convertSet(processDefinitionDOs, BpmProcessDefinitionExtPO::getFormId);
