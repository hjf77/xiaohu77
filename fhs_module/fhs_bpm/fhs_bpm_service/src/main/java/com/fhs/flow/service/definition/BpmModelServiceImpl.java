...
public class BpmModelServiceImpl implements BpmModelService {
    ...
    public PageResult<BpmModelPageItemRespVO> getModelPage(BpmModelPageReqVO pageVO) {
        ...
        Map<Long, BpmFormPO> formMap = bpmFormService.getFormMap(formIds);
    ...
    public void deployModel(String id) {
        ...
        // 1.3 校验表单已配
        BpmFormPO form = checkFormConfig(model.getMetaInfo());
        // 1.4 校验任务分配规则已配置
     ...
     * @return 流程表单
     */
    private BpmFormPO checkFormConfig(String  metaInfoStr) {
        ...
        if (Objects.equals(metaInfo.getFormType(), BpmModelFormTypeEnum.NORMAL.getType())) {
            BpmFormPO form = bpmFormService.getForm(metaInfo.getFormId());
            if (form == null) {
