...
public interface BpmTaskAssignRuleService {
     ...
     * @return 任务规则数组
     */
    List<BpmTaskAssignRulePO> getTaskAssignRuleListByProcessDefinitionId(String processDefinitionId,
     ...
     * @return 任务规则数组
     */
    List<BpmTaskAssignRulePO> getTaskAssignRuleListByModelId(String modelId);
