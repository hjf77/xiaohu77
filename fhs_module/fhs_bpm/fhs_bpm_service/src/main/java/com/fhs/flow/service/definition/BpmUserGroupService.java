...
public interface BpmUserGroupService {
     ...
     * @return 用户组
     */
    BpmUserGroupPO getUserGroup(Long id);
     ...
     * @return 用户组列表
     */
    List<BpmUserGroupPO> getUserGroupList(Collection<Long> ids);
     ...
     * @return 用户组列表
     */
    List<BpmUserGroupPO> getUserGroupListByStatus(Integer status);
     ...
     * @return 用户组分页
     */
    PageResult<BpmUserGroupPO> getUserGroupPage(BpmUserGroupPageReqVO pageReqVO);
