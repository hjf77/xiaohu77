...
public interface BpmModelConvert {
    ...
    default List<BpmModelPageItemRespVO> convertList(List<Model> list, Map<Long, BpmFormPO> formMap,
    ...
    default BpmModelPageItemRespVO convert(Model model, BpmFormPO form, Deployment deployment, ProcessDefinition processDefinition) {
    ...
    default BpmProcessDefinitionCreateReqDTO convert2(Model model, BpmFormPO form) {
