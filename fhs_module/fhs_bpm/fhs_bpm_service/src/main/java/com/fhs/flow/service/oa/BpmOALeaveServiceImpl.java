package com.fhs.flow.service.oa;
...
import com.fhs.flow.dal.mysql.oa.BpmOALeaveMapper;
import com.fhs.flow.enums.task.BpmProcessInstanceResultEnum;
import com.fhs.flow.service.BpmProcessInstanceService;
...
import static com.fhs.flow.enums.ErrorCodeConstants.OA_LEAVE_NOT_EXISTS;
...
public class BpmOALeaveServiceImpl implements BpmOALeaveService {
    ...
    public Long createLeave(Long userId, BpmOALeaveCreateReqVO createReqVO) {
        ...
        BpmOALeavePO leave = BpmOALeaveConvert.INSTANCE.convert(createReqVO).setUserId(userId).setDay(day)
        ...
        // 将工作流的编号，更新到 OA 请假单中
        leaveMapper.updateById(new BpmOALeavePO().setId(leave.getId()).setProcessInstanceId(processInstanceId));
        return leave.getId();
    }
    ...
    public void updateLeaveResult(Long id, Integer result) {
        ...
        leaveMapper.updateById(new BpmOALeavePO().setId(id).setResult(result));
    }
    ...
    @Override
    public BpmOALeavePO getLeave(Long id) {
        return leaveMapper.selectById(id);
    }

    @Override
    public PageResult<BpmOALeavePO> getLeavePage(Long userId, BpmOALeavePageReqVO pageReqVO) {
