package com.fhs.flow.framework.flowable.core.listener;
...
/**
 * 监听 {@link org.flowable.task.api.Task} 的开始与完成，创建与更新对应的 {@link com.fhs.flow.dal.dataobject.task.BpmTaskExtPO} 记录
 *
 * @author jason
 */
@Component
