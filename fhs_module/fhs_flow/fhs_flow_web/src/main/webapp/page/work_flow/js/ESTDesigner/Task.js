...
ESTDesigner.task.BaseTask = draw2d.shape.basic.Rectangle.extend({
			init : function(attr, setter, getter) {
				...
				this._super($.extend({
									id : "task"+ESTDesigner.tool.UUID.create()
								}, attr), $.extend({
									type : this.setType,
									title : this.setTitle,
...
ESTDesigner.task.UserTask = ESTDesigner.task.BaseTask.extend({
			init : function(attr, setter, getter) {
				this._super($.extend({
									...
									title : "",
									iconPath : "${basePath}/page/work_flow/js/ESTDesigner/icons/type.user.png"
								}, attr), setter, getter);
			...
			getCandidateUser : function(userId) {
...
ESTDesigner.task.ServiceTask = ESTDesigner.task.BaseTask.extend({
			init : function(attr, setter, getter) {
				this._super($.extend({
									...
									title : "",
									iconPath : "${basePath}/page/work_flow/js/ESTDesigner/icons/type.service.png"
								}, attr), setter, getter);
				this._type = null;
...
ESTDesigner.task.ScriptTask = ESTDesigner.task.BaseTask.extend({
			init : function(attr, setter, getter) {
				this._super($.extend({
									...
									title : "",
									iconPath : "${basePath}/page/work_flow/js/ESTDesigner/icons/type.script.png"
								}, attr), setter, getter);
...
ESTDesigner.task.ReceiveTask = ESTDesigner.task.BaseTask.extend({
			init : function(attr, setter, getter) {
				this._super($.extend({
									...
									title : "",
									iconPath : "${basePath}/page/work_flow/js/ESTDesigner/icons/type.receive.png"
								}, attr), setter, getter);
			},
			getStartElementXML : function() {
				var xml = '<receiveTask ';
...
ESTDesigner.task.ManualTask = ESTDesigner.task.BaseTask.extend({
			init : function(attr, setter, getter) {
				this._super($.extend({
									...
									title : "",
									iconPath : "${basePath}/page/work_flow/js/ESTDesigner/icons/type.manual.png"
								}, attr), setter, getter);
			},
			getStartElementXML : function() {
				var xml = '<task ';
...
ESTDesigner.task.MailTask = ESTDesigner.task.BaseTask.extend({
			init : function(attr, setter, getter) {
				this._super($.extend({
									...
									title : "",
									iconPath : "${basePath}/work_flow/js/ESTDesigner/icons/type.send.png"
								}, attr), setter, getter);
				this.to = null;
				this.from = null;
				this.subject = null;
...
ESTDesigner.task.CallActivityTask = ESTDesigner.task.BaseTask.extend({
			init : function(attr, setter, getter) {
				this._super($.extend({
									...
									title : "",
									iconPath : "${basePath}/page/work_flow/js/ESTDesigner/icons/callactivity.png"
								}, attr), setter, getter);
...
ESTDesigner.task.BusinessRuleTask = ESTDesigner.task.BaseTask.extend({
			init : function(attr, setter, getter) {
				this._super($.extend({
									...
									title : "",
									iconPath : "${basePath}/page/work_flow/js/ESTDesigner/icons/type.business.rule.png"
								}, attr), setter, getter);
