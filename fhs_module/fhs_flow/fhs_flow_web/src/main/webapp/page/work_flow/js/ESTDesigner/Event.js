...
ESTDesigner.event.Start = ESTDesigner.event.BaseEvent
		.extend({
			init : function(attr) {
				...
				this._super($.extend({
					path : fhs_base_path + "/page/work_flow/js/ESTDesigner/icons/type.startevent.none.png"
				}, attr));
...
ESTDesigner.event.End = ESTDesigner.event.BaseEvent
		.extend({
			init : function(attr) {
				...
				this._super($.extend({
					path : fhs_base_path + "/page/work_flow/js/ESTDesigner/icons/type.endevent.none.png"
				}, attr));
