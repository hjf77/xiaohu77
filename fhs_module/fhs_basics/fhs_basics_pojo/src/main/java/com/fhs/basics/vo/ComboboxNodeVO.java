...
public class ComboboxNodeVO {
     ...
     * The children.
     */
    private List<ComboboxNodeVO> children = new ArrayList<>();
     ...
     * @param text the text
     */
    public ComboboxNodeVO(String id, String text) {
        super();
        this.id = id;
        this.text = text;
     ...
     * @return children
     */
    public List<ComboboxNodeVO> getChildren() {
        return children;
    }
     ...
     */
    public void setChildren(List<ComboboxNodeVO> children) {
