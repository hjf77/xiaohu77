 ...
 */
@Data
public class SystemHardwareInfoVO {
     ...
     * 內存相关信息
     */
    private MemInfoVO mem = new MemInfoVO();
     ...
     * 服务器相关信息
     */
    private SysInfoVO sys = new SysInfoVO();

    /**
     * 磁盘相关信息
     */
    private List<SysFileInfoVO> sysFiles = new LinkedList<>();
    ...
    private void setSysInfo() {
        ...
        sys.setComputerIp(NetworkUtil.getLocalhostIp());
    ...
    private void setSysFiles(OperatingSystem os) {
        ...
        for (OSFileStore fs : fsArray) {
            ...
            SysFileInfoVO sysFile = new SysFileInfoVO();
