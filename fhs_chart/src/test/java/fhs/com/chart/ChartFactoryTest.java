...
import com.fhs.chart.ChartFactory;
import com.fhs.chart.Serie;
...
public class ChartFactoryTest {
    ...
    @Test
    public void testCreateBarLineChart() throws Exception {
        // 标注类别
        String[] categories = {"Jan", "Feb", "Mar", "Apr", "May", "Jun",
                "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"};
        Vector<Serie> series = new Vector<Serie>();
        ...
        Vector<Serie> seriesline = new Vector<Serie>();
        // 柱子名称：柱子所有的值集合
        seriesline.add(new Serie("Tokyo", new Double[]{10d, 20d, 20d, 20d,
