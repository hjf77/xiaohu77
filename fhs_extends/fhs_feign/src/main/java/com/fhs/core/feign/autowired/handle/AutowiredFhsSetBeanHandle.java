package com.fhs.core.feign.autowired.handle;
 ...
 */
public class AutowiredFhsSetBeanHandle implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public void initAutowareYLM(ContextRefreshedEvent contextRefreshedEvent) {
        ...
        TypeFilter entityFilter = AnnotationTypeFilterBuilder.build(AutowiredFhs.class);
