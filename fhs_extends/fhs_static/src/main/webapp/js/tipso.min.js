        ...
        t.extend(r.prototype, {
            ...
            show: function() {
                var s = this.tooltip(),
                    e = this,
                    r = t(o);
                var _content = e.content();
                if(_content.length>20){
                    e.settings.width = 200;
                }
                t.isFunction(e.settings.onBeforeShow) && e.settings.onBeforeShow(t(this)),
                    ...
                    s.find(".tipso_content").html(_content),
                    a(e),
                    r.resize(function() {
                        a(e)
                    }),
            ...
            content: function() {
                ...
                return o = e.settings.ajaxContentUrl ? t.ajax({
                    ...
                    async: !1
                }).responseText: e.settings.content ? e.settings.content: e.settings.useTitle === !0 ? r: $(s).text()
            },
            update: function(t, o) {
                var s = this;
