...
(function () {
    ...
    window.UMEDITOR_CONFIG = {
        ...
        //图片上传配置区
        ,imageUrl:fileService + '/um/imageUp'             //图片上传提交地址
        ...
        ,toolbar:[
            'source | undo redo | bold italic underline strikethrough | superscript subscript lineheight | forecolor backcolor | removeformat |',
