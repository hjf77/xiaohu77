 ...
 */
@Component
public class ButtonFormTag extends EmptyFormTag {

    static {
        FormTagFactory.regTag("btn", ButtonFormTag.class);
    }
    ...
    public String getContentHtml() {
        ...
        resultHtmlBuilder.append("<div class='bigLabelDiv'>");
        resultHtmlBuilder.append(" <label>&nbsp;</label></div><div class='bigContent'><a href='javascript:void(0)' ");
        resultHtmlBuilder.append(formartClass("easyui-linkbutton"));
        resultHtmlBuilder.append(getOtherAttrValHtml() + " >" + this.tagSett.get("title") + "</a>");
